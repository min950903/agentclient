...
public class AgentClient {
	...
	private static void writeLog(int statusCode, String resultMessage) {
		final String AGENT_LOG_PATH = "C:" + File.separator + "agent" + File.separator + "log" + File.separator;
		...
		try {
			...
			printWriter = new PrintWriter(new FileOutputStream(Paths.get(AGENT_LOG_PATH).toString() + File.separator + "log.txt", true));
